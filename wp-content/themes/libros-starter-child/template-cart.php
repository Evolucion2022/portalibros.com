<?php
/**
 * Template: Cart Page (Custom wrapper with premium header + footer)
 *
 * This template is loaded via the template_include filter in functions.php
 * for the WooCommerce Cart page.
 */
...
<main class="site-main cart-page" style="background: var(--cart-bg, var(--shop-bg, #F6F4F0)); min-height: 60vh;">
    <div class="cart-page__container">
        ...
        <div class="cart-hero">
            ...
            <p class="cart-hero__subtitle">Revisa tus productos antes de continuar con la compra</p>
        </div>
        ...
        <div class="cart-continue">
            <a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>" class="cart-continue__link">
    ...
    <div class="home-footer__inner">
        ...
        <div class="home-footer__bottom">
            <span class="home-footer__copy">&copy;
                <?php echo date('Y'); ?> PortaLibros. Todos los derechos
                reservados.
            </span>
