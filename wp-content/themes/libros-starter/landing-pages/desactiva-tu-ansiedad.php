<?php
/**
 * Landing Page Template: Desactiva Tu Ansiedad
 *
 * Full landing page for WooCommerce product (Product ID: 17).
 * Replaces the default WooCommerce product layout entirely.
 * All content is hardcoded for maximum persuasion control.
 * CTA buttons use WooCommerce add-to-cart URLs.
 */
...
$checkout_url = libros_direct_checkout_url($product_id);

// Get product images from WooCommerce media library
$cover_id = $product->get_image_id();
$gallery_ids = $product->get_gallery_image_ids();
$cover_url = $cover_id ? wp_get_attachment_image_url($cover_id, 'hero-cover') : '';

// Map gallery images by index (bonus images uploaded in order)
$bono1_url = isset($gallery_ids[0]) ? wp_get_attachment_image_url($gallery_ids[0], 'bonus-thumb') : '';
$bono2_url = isset($gallery_ids[1]) ? wp_get_attachment_image_url($gallery_ids[1], 'bonus-thumb') : '';
$bono3_url = isset($gallery_ids[2]) ? wp_get_attachment_image_url($gallery_ids[2], 'bonus-thumb') : '';

// Author image — check if exists in uploads
$author_url = content_url('/uploads/2026/02/author.png');
?>
    ...
    <div class="container hero__container">
        <div class="hero__content">
            ...
            <div class="hero__cta-group reveal reveal--delay-3">
                <a href="<?php echo esc_url($checkout_url); ?>" class="btn btn--primary btn--large" id="cta-hero">
        ...
        <div class="hero__visual reveal reveal--right reveal--delay-2">
            <?php if ($cover_url): ?>
                <img src="<?php echo esc_url($cover_url); ?>" alt="Ebook Desactiva Tu Ansiedad — Método R.E.N.A.C.E."
...
<section class="section section--white" id="espejo">
    <div class="container container--narrow text-center">
        ...
        <p class="section__subtitle reveal">No estás exagerando. No estás loco/a. Y definitivamente no estás solo/a.</p>
        ...
        <div class="mirror-list">
            ...
            <div class="mirror-list__item reveal reveal--delay-3">
                <span class="mirror-list__icon">🔴</span>
                <span>Sientes un nudo en el pecho que no se va — los médicos dicen que "todo está bien", pero tú sabes
                    que algo no está bien.</span>
            </div>
...
<section class="section section--cream" id="agitacion">
    <div class="container container--narrow text-center">
        ...
        <div class="card card--accent reveal" style="text-align: left; margin-top: var(--space-6);">
            <p><strong>La ansiedad no se "quita sola".</strong> Sin las herramientas adecuadas, tiende a escalar.</p>
            ...
            <p>Según la OMS, <strong>el 40% de personas con ansiedad no tratada desarrollan depresión</strong> en los
                siguientes 12 meses. No porque sean débiles — sino porque no tenían un sistema que les mostrara el
                camino de salida.</p>
...
<section class="section section--white" id="metodo">
    <div class="container text-center">
        ...
        <p class="section__subtitle reveal">6 fases probadas que te llevan desde entender tu ansiedad hasta construir
            una vida libre de ella.</p>
        ...
        <div class="renace-grid" style="max-width: 900px; margin: 0 auto;">
            <div class="renace-step reveal reveal--delay-1">
                ...
                <div>
                    ...
                    <p class="renace-step__desc">Entiende qué es realmente la ansiedad, cómo funciona tu cerebro y por
                        qué la tienes tú.</p>
                </div>
            </div>
            <div class="renace-step reveal reveal--delay-2">
                ...
                <div>
                    ...
                    <p class="renace-step__desc">Mapea tus patrones personales, tus disparadores y tus señales de alerta
                        temprana.</p>
                </div>
            </div>
            ...
            <div class="renace-step reveal reveal--delay-4">
                ...
                <div>
                    ...
                    <p class="renace-step__desc">Pon todo en práctica con un plan paso a paso de 30 días — día por día,
                        sin adivinanzas.</p>
                </div>
            </div>
            <div class="renace-step reveal reveal--delay-5">
                ...
                <div>
                    ...
                    <p class="renace-step__desc">Diseña un estilo de vida que prevenga la ansiedad: sueño, alimentación,
                        relaciones, hábitos.</p>
                </div>
            </div>
...
<section class="section section--white" id="autora">
    <div class="container">
        <div class="author-section" style="max-width: 800px; margin: 0 auto;">
            <img src="<?php echo esc_url($author_url); ?>" alt="Sofía Morales — Psicóloga Clínica"
            ...
            <div class="reveal reveal--right">
                ...
                <p>Tenía 27 años cuando tuve mi primer ataque de pánico en un supermercado. Mi corazón se disparó, las
                    luces se volvieron demasiado brillantes, el suelo pareció moverse. Dejé el carrito y salí corriendo
                    al estacionamiento.</p>
                <p>Ese fue el día que mi vida se dividió en un «antes» y un «después». Irónico — una psicóloga que no
                    reconocía su propia ansiedad.</p>
...
<section class="section section--cream" id="testimonios">
    <div class="container text-center">
        ...
        <p class="section__subtitle reveal">Personas reales con ansiedad real. Sin promesas mágicas — solo resultados
            honestos.</p>

        <div style="display: grid; grid-template-columns: 1fr; gap: var(--space-5); max-width: 900px; margin: 0 auto;">
            <div class="testimonial-card reveal reveal--delay-1">
                <p class="testimonial-card__text">Llevaba 3 años con ataques de pánico. Probé de todo: meditaciones en
                    YouTube, apps, incluso hipnosis. El Método R.E.N.A.C.E. fue lo primero que me hizo ENTENDER por qué
                    me pasaba esto. En 30 días no desapareció del todo, pero aprendí a no tenerle miedo. Y eso lo cambió
                    todo.</p>
            ...
            <div class="testimonial-card reveal reveal--delay-2">
                <p class="testimonial-card__text">Soy ingeniero de software y mi ansiedad me impedía presentar
                    proyectos. Las manos me temblaban, la voz se me quebraba. Los capítulos de técnicas corporales me
                    dieron herramientas que uso ANTES de cada presentación. Mi jefe notó el cambio antes que yo.</p>
                <div class="testimonial-card__author">
                    <div>
            ...
            <div class="testimonial-card reveal reveal--delay-3">
                <p class="testimonial-card__text">No dormía bien desde hacía más de un año. El Kit de Emergencia fue lo
                    primero que usé — esa misma noche dormí 6 horas seguidas. No es magia, pero las técnicas de
    ...
    <div class="container text-center">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: var(--space-5); max-width: 900px; margin: 0 auto;">
            <div class="bonus-card reveal reveal--delay-1">
                ...
                <?php if ($bono1_url): ?>
                    <img src="<?php echo esc_url($bono1_url); ?>" alt="Kit de Emergencia Anti-Ansiedad"
                        class="bonus-card__img" width="180" height="240" loading="lazy" decoding="async">
                <?php endif; ?>
                <h4 class="bonus-card__title">Kit de Emergencia Anti-Ansiedad</h4>
                <p class="bonus-card__desc">Protocolos paso a paso para ataques de pánico, ansiedad nocturna y crisis en
                    público. Tu botiquín emocional de primeros auxilios.</p>
            ...
            <div class="bonus-card reveal reveal--delay-2">
                ...
                <?php if ($bono2_url): ?>
                    <img src="<?php echo esc_url($bono2_url); ?>" alt="Diario R.E.N.A.C.E." class="bonus-card__img"
                        width="180" height="240" loading="lazy" decoding="async">
                <?php endif; ?>
                <h4 class="bonus-card__title">Diario R.E.N.A.C.E. de 30 Días</h4>
                <p class="bonus-card__desc">Tu compañero diario para registrar progreso, emociones y victorias. Cada día
                    tiene una micro-reflexión guiada.</p>
            ...
            <div class="bonus-card reveal reveal--delay-3">
                ...
                <?php if ($bono3_url): ?>
                    <img src="<?php echo esc_url($bono3_url); ?>" alt="Recetas y Rutinas Anti-Estrés"
                        class="bonus-card__img" width="180" height="240" loading="lazy" decoding="async">
                <?php endif; ?>
                <h4 class="bonus-card__title">Recetas y Rutinas Anti-Estrés</h4>
                <p class="bonus-card__desc">5 recetas anti-inflamatorias + rutinas matutinas y nocturnas diseñadas para
                    calmar tu sistema nervioso.</p>
...
<section class="section section--dark" id="oferta">
    <div class="container text-center">
        ...
        <p class="section__subtitle reveal" style="color: rgba(254,252,243,0.7);">Un sistema completo por una fracción
            de lo que cuesta una sola sesión de terapia.</p>
        ...
        <div class="value-stack reveal reveal--scale animate-breathe">
            ...
            <div class="value-stack__total">
                ...
                <div>
                    <div style="font-size: var(--text-sm); color: var(--gray-soft); margin-bottom: 4px;">Hoy solo</div>
                    <span class="value-stack__final">$27</span>
                </div>
            </div>

            <div style="margin-top: var(--space-6); text-align: center;">
                <a href="<?php echo esc_url($checkout_url); ?>" class="btn btn--primary btn--large" id="cta-oferta"
                    style="width: 100%;">
        ...
        <div class="reveal" style="margin-top: var(--space-8);">
            <details class="faq-item">
                ...
                <div class="faq-item__answer">
                    <p>Es un libro 100% digital en formato PDF. Lo recibes al instante por email y puedes leerlo en tu
                        celular, tablet, computadora o imprimirlo si prefieres. Los bonos también son digitales.</p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-item__answer">
                    <p>El Método R.E.N.A.C.E. no es un listado de tips sueltos. Es un sistema integrado de 6 fases que
                        combina técnicas cognitivas, corporales y de estilo de vida en una secuencia probada. La mayoría
                        de libros te dicen QUÉ hacer — este te dice CÓMO y CUÁNDO, con un plan de 30 días día por día.
                    </p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-item__answer">
                    <p>No. Este libro es un complemento poderoso, no un reemplazo. Si estás en terapia, las herramientas
                        de este libro potenciarán tu proceso. Si no estás en terapia, te dará recursos para manejar tu
                        ansiedad y también una guía honesta (Capítulo 15) sobre cuándo y cómo buscar ayuda profesional.
                    </p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-item__answer">
                    <p>El plan de 30 días está diseñado para dedicarle entre 15 y 30 minutos diarios. Puedes leer un
                        capítulo completo en una sentada (20-30 minutos) y los ejercicios toman entre 5 y 15 minutos.
                    </p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-item__answer">
                    <p>Cada capítulo es corto y directo — no es un libro de 500 páginas. Además, puedes ir directo al
                        capítulo que necesites sin leer en orden. Si necesitas ayuda AHORA MISMO, los capítulos 6-9 y el
                        Kit de Emergencia son tu punto de partida.</p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-item__answer">
                    <p>Tienes 7 días de garantía total. Si por cualquier motivo sientes que no es para ti, te devolvemos
                        tu dinero completo sin hacer una sola pregunta. El riesgo es cero.</p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-item__answer">
                    <p>Inmediatamente después de tu compra recibirás un email con tu enlace de descarga. En menos de 2
                        minutos tendrás el ebook y los 3 bonos en tu dispositivo. Si no ves el email, revisa tu carpeta
                        de spam.</p>
                </div>
            </details>
        </div>
...
<section class="section section--dark" id="cta-final">
    <div class="container container--narrow text-center">
        ...
        <div class="reveal">
            <a href="<?php echo esc_url($checkout_url); ?>" class="btn btn--primary btn--large" id="cta-final-btn">
                <span class="btn__icon">🌿</span> Sí, Quiero Mi Paz de Vuelta
            </a>
        </div>
        <p class="reveal" style="margin-top: var(--space-4); color: rgba(254,252,243,0.4); font-size: var(--text-xs);">
...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer__links">
            ...
            <a href="mailto:soporte@libros.javired.com">Contacto</a>
        </div>

        <p style="font-size: var(--text-xs); color: rgba(254,252,243,0.35);">
            ©
            <?php echo date('Y'); ?> libros.javired.com — Todos los derechos reservados.
        </p>

        <p class="footer__disclaimer">
            Este producto es informativo y educativo. No sustituye la consulta con un profesional de la salud mental.
            Los resultados pueden variar según la persona y la constancia en la aplicación del método.
        </p>
    </div>
</footer>